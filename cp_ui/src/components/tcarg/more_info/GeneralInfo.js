...
const GeneralInfo = (props) => {
  ...
  if (props.language === 'ESP'){
    text = (<Text>
            ...
            <h3 > Turno mañana: </h3>
              <ul>
                <li> <strong> De 9:00 a 11:00 hs (UTC-3):</strong> resolución de problemas de competencias de días previos. El primer día realizaremos una bienvenida e introducción al evento en este horario. </li>
                <li> <strong> De 11:00 a 13:00 hs (UTC-3): </strong> clases teóricas en donde se explicarán algoritmos, técnicas, estructuras y trucos útiles para las competencias de programación. </li>
    ...
    text = (<Text>
            ...
            <h3 > Morning shift: </h3>
              <ul>
                <li> <strong> From 9:00 to 11:00 hs (UTC-3):</strong> resolution of competition problems from previous days. On the first day we will have a welcome and introduction to the event at this time.</li>
                <li> <strong> From 11:00 to 13:00 hs (UTC-3): </strong> Theoretical classes where algorithms, techniques, structures and useful tricks for programming skills will be explained. </li>
