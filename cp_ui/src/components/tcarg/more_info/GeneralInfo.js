    ...
    text = (<Text>
            ...
            <h3 > Turno mañana: </h3>
              <ul>
                ...
                <li> Las clases serán por streaming con interacción por chat y se transmitirán por Youtube (<a href='https://www.youtube.com/channel/UCTtoEdiHyjP6XmxMGhsngCA' target="_blank"> enlace al canal </a>) </li>
              </ul>

            <h3 > Turno tarde </h3>
            <p> Se realizará una competencia para cada nivel, al estilo ICPC, cada día con duración de 5 horas. La misma será desde las 15:00 hasta las 20:00 hs (UTC-3). Se va a utilizar Codeforces (https://www.codeforces.com) para hostear los contests. Estos se encontrarán en un grupo creado para el evento, al cual es obligatorio unirse <a href="https://codeforces.com/group/j1UosVRZar" > enlace codeforces </a>. </p>
    ...
    text = (<Text>
            ...
            <h3 > Morning shift: </h3>
              <ul>
                ...
                <li> The classes will be by streaming with chat interaction, and it will be transmitted on Youtube (<a href='https://www.youtube.com/channel/UCTtoEdiHyjP6XmxMGhsngCA' target="_blank"> Channel </a>) </li>
              </ul>

            <h3 > Afternoon shift </h3>
            <p> There will be a competition for each level, ICPC style, each day lasting 5 hours. It will be from 3:00 p.m. to 8:00 p.m. (UTC-3). Codeforces (https://www.codeforces.com) will be used to host the contests. These will be found in a group created for the event, which is mandatory to join <a href="https://codeforces.com/group/j1UosVRZar" > Codeforces </a>. </p>
