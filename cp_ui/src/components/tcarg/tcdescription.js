...
const tcIntroData = {
  ESP: {
    ...
    description: [
      ...
      "El Training Camp se organiza todos los años desde 2010 durante el receso invernal en distintas universidades de la Argentina. La edición 2021 será la duodécima edición y se realizará de manera virtual.",
      "El Training Camp dura dos semanas, de lunes a viernes, de 9 a 18hs."
    ],
  ...
  ENG: {
    ...
    description: [
      ...
      "The Training Camp has been organized every year since 2010 during the winter break in different universities in Argentina. The 2021 edition will be the twelfth edition and will run virtually.",
      "The Training Camp lasts two weeks, Monday through Friday, from 9 a.m. to 6 p.m."
    ],
